...
import logoImage from 'assets/new-assets/logo.svg';
...
import Recipe from '../ask-for-recipe';
import Featured from 'sections/library-search-filter';
  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">AI Recipe Generator</Heading>
        <Featured />
      </Container>
    </Box>
  );
